...
@Component({
    selector: 'app-levantamiento-procesando-list',
    templateUrl: './levantamiento-procesando-list.component.html',
    styleUrls: ['./levantamiento-procesando-list.component.scss']
})
export class LevantamientoProcesandoListComponent implements OnInit, AfterViewInit {
