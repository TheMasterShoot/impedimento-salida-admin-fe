...
@Component({
    selector: 'app-levantamiento-emitido-list',
    templateUrl: './levantamiento-emitido-list.component.html',
    styleUrls: ['./levantamiento-emitido-list.component.scss']
})
export class LevantamientoEmitidoListComponent implements OnInit, AfterViewInit {
